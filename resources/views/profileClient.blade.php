...
@section('content-head')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>الملف الشخصي ({{$client->code_client}})</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/dashboard">المكتب</a></li>
                    <li class="breadcrumb-item"><a href="/clients">الزبائن</a></li>
            ...
            <div class="col-md-3">
                ...
                <div class="card card-indigo card-outline">
                    <div class="card-body box-profile">
                        ...
                        <h3 class="profile-username text-center">{{$client->nom}}</h3>

                        <p class="text-muted text-center">زبون</p>

                        <ul class="list-group list-group-unbordered mb-3">
                            <li class="list-group-item">
                                <b>موبايل 1</b> <a class="float-right">{{$client->mobile1}}</a>
                            </li>
                            <li class="list-group-item">
                                <b>الدين</b> <a class="float-right">{{$client->credit}}</a>
                            </li>
                            <li class="list-group-item">
                                <b>آخر دفع</b> <a class="float-right">{{$client->dernier_verssement}}</a>
                            </li>
                            <li class="list-group-item">
                                <b>رأس المال</b> <a class="float-right">{{$client->chifre_affaire}}</a>
                            </li>
                        </ul>

                        <a href="/client/dell/{{$client->id}}" class="btn btn-danger btn-block"><b>حذف الزبون</b></a>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
                ...
                <div class="card card-success collapsed-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted">{{$client->telephone1}}</p>

                        <hr>

                        <strong><i class="fas fa-mobile-alt mr-1"></i> الهاتف 2</strong>

                        <p class="text-muted">{{$client->telephone2}}</p>

                        <hr>

                        <strong><i class="fas fa-mobile-alt mr-1"></i> موبايل 2</strong>

                        <p class="text-muted">{{$client->mobile2}}</p>
                        ...
                        <p class="text-muted">{{$client->code_postale}}</p>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="settings">
                                <form action="client" id="id_form_client">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="client_nom" value="{{$client->nom}}" required>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="client_adresse" value="{{$client->adresse}}" required>
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="client_ville" value="{{$client->ville}}" required>
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" class="form-control" name="client_mobile1" value="{{$client->mobile1}}" required>
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" class="form-control" name="client_mobile2" value="{{$client->mobile2}}">
                                                </div>
                                                <!-- /.input group -->
                                                <small class="form-text text-muted">هدا الحقل ليس إلزامي</small>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" class="form-control" name="client_telephone1" value="{{$client->telephone1}}">
                                                </div>
                                                <!-- /.input group -->
                                                <small class="form-text text-muted">هدا الحقل ليس إلزامي</small>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" class="form-control" name="client_telephone2" value="{{$client->telephone2}}">
                                                </div>
                                                <!-- /.input group -->
                                                <small class="form-text text-muted">هدا الحقل ليس إلزامي</small>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" class="form-control" name="client_email" value="{{$client->email}}">
                                                </div>
                                                <!-- /.input group -->
                                                <small class="form-text text-muted">هدا الحقل ليس إلزامي</small>
                                            </div>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" name="client_code_postale" value="{{$client->code_postale}}">
                                                </div>
                                                <!-- /.input group -->
                                                <small class="form-text text-muted">هدا الحقل ليس إلزامي</small>
                                            </div>
...
@section('additionel script')
    <script>
        ...
        $('#id_form_client').submit(function (e) {
            e.preventDefault();
            $.ajax({
                method:'POST',
                data:$(this).serialize(),
